...
```{r study1_p1p2_consensus_sam_rfx_tbl, cache = FALSE}
study1_consensus_sam %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_rfx_tbl, cache = FALSE}
study1_accuracy_sam_combined %>% 
  random_coefs_tbl()
```
...
```{r study1_p2_simple_rfx_tbl, cache = FALSE}
study1_accuracy_simple_sam_p2 %>% 
  random_coefs_tbl()
```
...
```{r study1_consensus_sam_t_ext_rfx_tbl, cache = FALSE}
study1_consensus_sam_t_ext %>% 
  random_coefs_tbl()
```
...
```{r study1_consensus_sam_p1_ext_rfx_tbl, cache = FALSE}
study1_consensus_sam_p1_ext %>% 
  random_coefs_tbl()
```
...
```{r study1_consensus_sam_p2_ext_rfx_tbl, cache = FALSE}
study1_consensus_sam_p2_ext %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_t_ext_rfx_tbl, cache = FALSE}
study1_accuracy_sam_t_ext %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_p1_ext_rfx_tbl, cache = FALSE}
study1_accuracy_sam_p1_ext %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_p2_ext_rfx_tbl, cache = FALSE}
study1_accuracy_sam_p2_ext %>% 
  random_coefs_tbl()
```
...
```{r study1_consensus_sam_empathic_rfx_tbl, cache = FALSE}
study1_consensus_sam_empathic %>% 
  random_coefs_tbl()
```
...
```{r study1_consensus_sam_fantasy_rfx_tbl, cache = FALSE}
study1_consensus_sam_fantasy %>% 
  random_coefs_tbl()
```
...
```{r study1_consensus_sam_perspective_rfx_tbl, cache = FALSE}
study1_consensus_sam_perspective %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_distress_rfx_tbl, cache = FALSE}
study1_accuracy_sam_distress %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_empathic_rfx_tbl, cache = FALSE}
study1_accuracy_sam_empathic %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_fantasy_rfx_tbl, cache = FALSE}
study1_accuracy_sam_fantasy %>% 
  random_coefs_tbl()
```
...
```{r study1_accuracy_sam_perspective_rfx_tbl, cache = FALSE}
study1_accuracy_sam_perspective %>% 
  random_coefs_tbl()
```
...
```{r study2_p1p2_consensus_sam_rfx_tbl, cache = FALSE}
study2_consensus_sam %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_rfx_tbl, cache = FALSE}
study2_accuracy_sam_combined %>% 
  random_coefs_tbl()
```
...
```{r study2_simple_accuracy_p2_rfx_tbl, cache = FALSE}
study2_accuracy_simple_sam_p2 %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_t_ext_rfx_tbl, cache = FALSE}
study2_consensus_sam_t_ext %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_p1_ext_rfx_tbl, cache = FALSE}
study2_consensus_sam_p1_ext %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_p2_ext_rfx_tbl, cache = FALSE}
study2_consensus_sam_p2_ext %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_t_ext_rfx_tbl, cache = FALSE}
study2_accuracy_sam_t_ext %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_p1_ext_rfx_tbl, cache = FALSE}
study2_accuracy_sam_p1_ext %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_p2_ext_rfx_tbl, cache = FALSE}
study2_accuracy_sam_p2_ext %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_distress_rfx_tbl, cache = FALSE}
study2_consensus_sam_distress %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_empathic_rfx_tbl, cache = FALSE}
study2_consensus_sam_empathic %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_fantasy_rfx_tbl, cache = FALSE}
study2_consensus_sam_fantasy %>% 
  random_coefs_tbl()
```
...
```{r study2_consensus_sam_perspective_rfx_tbl, cache = FALSE}
study2_consensus_sam_perspective %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_distress_rfx_tbl, cache = FALSE}
study2_accuracy_sam_distress %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_empathic_rfx_tbl, cache = FALSE}
study2_accuracy_sam_empathic %>% 
  random_coefs_tbl()
```
...
```{r study2_accuracy_sam_fantasy_rfx_tbl, cache = FALSE}
study2_accuracy_sam_fantasy %>% 
  random_coefs_tbl()
```
#### Perspective Taking moderating Hearsay accuracy
